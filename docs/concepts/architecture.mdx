...
<Frame caption="PolicyKit architecture: policy deployment and transaction evaluation flow">
  <img src="/images/policykit-architecture.png" alt="PolicyKit Architecture Diagram" />
</Frame>
