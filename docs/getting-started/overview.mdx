...
Solidity contracts deployed on-chain that enforce policy rules. Available as an [npm package](https://www.npmjs.com/package/@policykit/contracts) for use in your own Solidity projects:
...
TypeScript code executed on the Lit Protocol network for off-chain rule evaluation. Available as an [npm package](https://www.npmjs.com/package/@policykit/lit-actions) containing the pre-built action bundle and source rules. The Lit Action:
